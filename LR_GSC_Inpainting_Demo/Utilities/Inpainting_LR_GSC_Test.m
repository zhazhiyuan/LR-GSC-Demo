function  [filename, p_miss, alpha, beta, mu,  c1, c2, j, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= Inpainting_LR_GSC_Test(filename, IterNum, p_miss, alpha,beta, mu,c1, c2 )
     ...
     fprintf('..................LR_GSC Algorithm for text removal.............\n');
     
     else
         
     fprintf('..............LR_GSC Algorithm for random missing pixels.....   ratio = %f\n',ratio);
     ...
     [reconstructed_image, PSNR_Final,FSIM_Final,SSIM_Final, All_PSNR,j, Err_or] = Inpainting_LR_GSC_Main(y,Opts);
      ...
      Time_s                         =                 (etime(clock,time0)); 
        ...
        if ratio==0.1
         ...
         Final_Name= strcat(filename,'_LR_GSC_miss_',num2str(1-ratio), '_PSNR_',num2str(PSNR_Final), '_FSIM_',num2str(FSIM_Final), '_SSIM_',num2str(SSIM_Final),'.png');
