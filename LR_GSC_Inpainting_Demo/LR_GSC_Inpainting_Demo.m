...
c2                 =      1;
 ...
 if  p_miss==0.1
     ...
     alpha = 0.6;  beta = 0.003;  mu = 0.001;
     

 [Ori, p_miss, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= Inpainting_LR_GSC_Test(filename, IterNum, p_miss, alpha, beta, mu, c1, c2);
 
 m_1= m_1+1;
 
 s=strcat('A',num2str(m_1));
 
 All_data_Results_1{m_1}={Ori, p_miss,  PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
 
 xlswrite('Inpaint_LR_GSC_90_miss_Test_Final.xls', All_data_Results_1{m_1},'sheet1',s);
...
[Ori, p_miss, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= Inpainting_LR_GSC_Test(filename, IterNum, p_miss, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_4{m_4}={Ori, p_miss,  PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
 
 xlswrite('Inpaint_LR_GSC_80_miss_Test_Final.xls', All_data_Results_4{m_4},'sheet1',s);


 
 elseif  p_miss==0.3
     
          alpha = 0.6;  beta = 0.04;  mu = 0.001;
...
[Ori, p_miss, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= Inpainting_LR_GSC_Test(filename, IterNum, p_miss, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_7{m_7}={Ori, p_miss,  PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
...
[Ori, p_miss, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= Inpainting_LR_GSC_Test(filename, IterNum, p_miss, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_10{ m_10}={Ori, p_miss,  PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
...
[Ori, p_miss, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= Inpainting_LR_GSC_Test(filename, IterNum, p_miss, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_13{ m_13}={Ori, p_miss,  PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
...
[Ori, p_miss, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= Inpainting_LR_GSC_Test(filename, IterNum, p_miss, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_16{ m_16}={Ori, p_miss,  PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
 
 xlswrite('Inpaint_LR_GSC_text_miss_Test_Final_4.xls', All_data_Results_16{ m_16},'sheet1',s);        
